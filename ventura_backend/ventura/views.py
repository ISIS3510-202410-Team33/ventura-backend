...
def extract_keywords(reviews):
    ...
    for review in reviews:  # Iterar sobre cada reseña en la lista
        rating, text = review  # Desempaquetar la reseña en su puntuación y texto
...
def download_keywords_for_edificios(request):
    ...
    # Obtener el archivo "calificaciones.json" del almacenamiento de Firebase
    blob = bucket.blob("calificaciones.json")
    blob_content = blob.download_as_string()
    json_data = json.loads(blob_content)

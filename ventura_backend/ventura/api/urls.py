...
from ventura.api.views import CollegeViewSet, College_locationViewSet, usersViewSet, user_calificationsViewSet, user_frequenciesViewSet, UserFrequencyLocationAnalysisViewSet
...
router.register(r'user_frequencies/analysis', UserFrequencyLocationAnalysisViewSet, basename='user_frequency_analysis')
